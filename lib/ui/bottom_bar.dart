...
class _BottomBarState extends State<BottomBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final UserModel loggedInUser = Provider.of<UserProvider>(context, listen: true).user;
    print('cart size is:');
      ...
      body: SafeArea(
        child: Consumer<UserProvider>(
          builder: (context,prov,child){
            ...
            return (loggedInUser.name=='loading')?
            ...
            :Scaffold(
              ...
              bottomNavigationBar: BottomNavigationBar(
                currentIndex:
                _page, //this selects the item in nav bar (0 based indexing)
                  ...
                  BottomNavigationBarItem(
                    icon: Badge(
                      ...
                      badgeContent: Text(Provider.of<UserProvider>(context,
                          ...
                          .cart
                          .length
                          .toString()), //Text(loggedInUser!.cart!.length.toString()),
